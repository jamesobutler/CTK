...
macro(ctkMacroBuildQtPlugin)
  ...
  if(CTK_QT_VERSION VERSION_GREATER "4")
    set(target)
    if(Qt${QT_VERSION_MAJOR}Core_VERSION VERSION_GREATER "5.2.0")
      set(target TARGET ${MY_LIBNAME})
    endif()
    qt${QT_VERSION_MAJOR}_wrap_cpp(MY_MOC_CPP ${MY_MOC_SRCS} OPTIONS -DHAVE_QT${QT_VERSION_MAJOR} ${target})
  ...
  if(CTK_QT_VERSION VERSION_GREATER "4")
    ...
    elseif(MY_UI_FORMS)
      message(WARNING "Argument UI_FORMS ignored because Qt${QT_VERSION_MAJOR}Widgets module was not specified")
    endif()
  else()
  ...
  if(CTK_QT_VERSION VERSION_GREATER "4")
    set(compile_flags "${compile_flags} -DHAVE_QT${QT_VERSION_MAJOR}")
  endif()
...
macro(ctkMacroBuildQtDesignerPlugin)
  if(CTK_QT_VERSION VERSION_GREATER "4")
    ...
    add_definitions(${Qt${QT_VERSION_MAJOR}Designer_DEFINITIONS})
    include_directories(${Qt${QT_VERSION_MAJOR}Designer_INCLUDE_DIRS})
  endif()
  ...
  if(CTK_QT_VERSION VERSION_GREATER "4")
    ...
    target_link_libraries(${MY_NAME} Qt${QT_VERSION_MAJOR}::Designer)
  endif()
endmacro()
