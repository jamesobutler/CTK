...
macro(ctkMacroBuildPlugin)
  ...
  if (CTK_QT_VERSION VERSION_GREATER "4")
    ...
    if(MY_MOC_SRCS)
      ...
      foreach(moc_src ${MY_MOC_SRCS})
        QT${QT_VERSION_MAJOR}_WRAP_CPP(MY_MOC_CPP ${moc_src} OPTIONS -f${moc_src} -DHAVE_QT${QT_VERSION_MAJOR} ${MY_MOC_OPTIONS} ${target})
      endforeach()
    endif()
  ...
  if(MY_TRANSLATIONS)
    ...
    if(CTK_QT_VERSION VERSION_GREATER "4")
      qt${QT_VERSION_MAJOR}_create_translation(_plugin_qm_files ${MY_SRCS} ${MY_UI_FORMS} ${MY_TRANSLATIONS})
    else()
  ...
  if(MY_TEST_PLUGIN AND CTK_QT_VERSION VERSION_GREATER "4")
    ...
    if(CMAKE_VERSION VERSION_LESS 2.8.12)
      target_link_libraries(${lib_name} Qt${QT_VERSION_MAJOR}::Test)
    else()
      target_link_libraries(${lib_name} PRIVATE Qt${QT_VERSION_MAJOR}::Test)
    endif()
  endif()
